...
# fig = plt.figure()
# plot = plt.plot( timemesa, fracunboundmesa, c='r', lw=2, label = 'MESA' )
# plot = plt.plot( timead, fracunboundad, c='b', lw=2, label = 'Adiabatic' )
# plot = plt.plot( timesph, fracunboundsph, c='g', lw=2, label = 'SPH' )
# plt.legend()
# plt.xlabel('Time (' + timelabel + ')', fontsize=25 )
